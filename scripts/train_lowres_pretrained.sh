...
python ./train.py \
--pretrained_hr_syn_checkpoint_dir '/media/Data1/zhouyuemei/models/AttentionRefSR/AttentionRefSR_pretrain_hr_syn_guided_nnup_denseASPP_lowres_image_psv_lowresL1_pretrain' \
...
--experiment_name 'AttentionRefSR_pretrain_hr_syn_guided_nnup_denseASPP_lowres_image_psv_lowresL1_pretrained' \
